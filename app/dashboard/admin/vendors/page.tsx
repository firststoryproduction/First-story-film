            ...
            <div className="w-full px-2 py-4 lg:px-4 lg:py-6">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4 px-2">
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            <h1 className="text-xl font-semibold text-black">Vendors & Studios</h1>
                        </div>
                    </div>
                </div>
                            ...
                            <table className="w-full text-left border-collapse">
                                <thead>
                                    <tr className="bg-slate-100/80 border-b border-slate-200">
                                        <th className="px-6 py-3 text-xs font-medium text-gray-600 uppercase tracking-wide">Studio Details</th>
                                        <th className="px-6 py-3 text-xs font-medium text-gray-600 uppercase tracking-wide">Location</th>
                                        <th className="px-6 py-3 text-xs font-medium text-gray-600 uppercase tracking-wide">Contact Person</th>
                                        <th className="px-6 py-3 text-xs font-medium text-gray-600 uppercase tracking-wide">Contact Info</th>
